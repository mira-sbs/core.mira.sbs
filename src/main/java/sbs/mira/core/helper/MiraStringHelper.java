 ...
 */
public
class MiraStringHelper
  extends MiraModule<MiraPulse<?, ?>>
{
  
  private final Map<PotionEffectType, String> effects = new HashMap<>();
   ...
   */
  public
  MiraStringHelper( MiraPulse<?, ?> main)
  {
    super(main);
  ...
  if (pulse().master().match().getRawRoundID() == generated)
  {
  return generateID();
  }
